...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  // Fetch the current user to get the current avatar URL
  ...
  if (oldAvatarUrl) {
    await deleteImageOnCloudinary(oldAvatarUrl);
  }
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  // Fetch the current user to get the current coverImage URL
  ...
  // Update user with new coverImage URL
  const user = await User.findByIdAndUpdate(
    req.user?._id,
    {
      $set: {
